...
while True:
    ...
    tiltCompensatedHeading = tiltCompensatedHeading + declination

    if tiltCompensatedHeading > 360:
        tiltCompensatedHeading = tiltCompensatedHeading - 360

    if tiltCompensatedHeading < 0:
        tiltCompensatedHeading = tiltCompensatedHeading + 360

    tiltCompensatedHeading = 90 - tiltCompensatedHeading
